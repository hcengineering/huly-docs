...
The calendar view displays either a daily or weekly calendar of each team member's tasks. In the daily calendar, tasks are displayed as blocks, and can be viewed in 1-hour or 30-minute increments. The weekly calendar displays each team member's tasks on each day of the week. The calendar view - both daily and weekly - is still in development, so users are likely to find the agenda view more useful at this time.
