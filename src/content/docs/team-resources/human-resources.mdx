...
Selecting the table view in the top left corner allows you to see reporting for each team member. This view shows totals for vacation days, sick days, PTO, overtime and remote days, as well as calculations based on the number of tasks completed. This early implementation of time tracking in Huly is still in development, so we suggest using this feature as a general guide rather than a precise tracking tool until the functionality is complete.
