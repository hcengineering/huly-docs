...
Once you've set up the Huly platform for your team, dive deeper into all Huly has to offer by exploring some of these popular features, like [Todos](../../task-tracking/todos), [Chat](../../communication/chat) and [Virtual Office](../../communication/virtual-office).