...
import createWorkspace from '../../../assets/gifs/create-workspace.gif';
...
To configure Workspace settings, open the settings panel by clicking on the horizontal marks at the top left of the sidebar. The following settings can be configured:
