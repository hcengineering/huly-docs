...
The email mask can be used to restrict access to your workspace by only allowing users with specific email domains to join. For example, if you only want users with email addresses from your company domain to join your workspace, you can set the email mask to `@yourcompany.com`.
