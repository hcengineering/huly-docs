...
import createIssue from '../../../assets/gifs/create-issue.gif';
...
**Assignee**: Select a member to assign this Issue to. When you create an Issue assigned to a member, that member will recieve a [Todo](../../task-tracking/todos) in their Planner that will allow them to add it to their own schedule.
...
Now that you have created your first Workspace, Project and Issue, you're ready to dive deeper into all the rest of what Huly has to offer! Explore popular topics in depth like [Todos](../../task-tracking/todos), [Chat](../../communication/chat) and [Virtual Office](../../communication/virtual-office).
