...
Creating a Type derived from `File` is the same as creating any other derived Type (see steps for [Creating derived Types](/cards/types/creating-types/#creating-derived-types)).
