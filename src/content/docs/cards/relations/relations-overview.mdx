---
title: Relations
description: Learn about Relations.
---
...
In our **game design** example, a `Character` Card may be related to an `Item` Card that the character posesses, or a `Game System` Card could be related to a `Document` that explains how the system functions.
