...
!! INSERT IMAGE: Screenshot or video of opening relation dialog
...
* **Included in** (`Game Narrative`) - **Features characters** (`Character`)
  * *Meaning: A Game Narrative **features** a Character; a Character is **included in** a Game Narrative.*
...
## Selecting types for Relations

When creating a Relation, you must specify the type of relationship between the entities. There are three types to choose from:
