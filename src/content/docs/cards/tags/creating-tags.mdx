...
In the previous guide, we learned about Tags and how they can be used to define behaviors or attributes that extend a Card’s functionality. Now, let's put that knowledge into practice and create some Tags our Types.
