...
> **Note:** The recruiting module is disabled by default for new workspaces, as this feature set is not relevant for many users. If you'd like to enable the recruiting module, please contact our support team through <a href="https://huly.link/slack" target="_blank">Slack</a>.
