...
**Assignee**: Select a member to assign this Issue to. When you create an Issue assigned to a member, that member will receive a [Todo](../../team-workflows/todos) in their Planner that will allow them to add it to their own schedule.
