...
* **(Coming Soon!) Floating toolbar** - Hover over text and click the `+` icon that appears on the left side. Select the checkbox icon to create a new action item.
* **(Coming Soon!) Slash command** - Type `/` to open a dropdown menu of options. Select the checkbox icon to create a new action item.
