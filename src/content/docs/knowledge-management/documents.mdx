...
Rows and columns can be deleted by right-clicking the settings menu that appears when hovering over the row or column. The entire table can be deleted by highlighting some text in any cell to reveal the floating toolbar, selecting the table icon, and clicking `Delete table`.
...
<YouTube id="cspdJ5TjFNQ" posterQuality="max" />
