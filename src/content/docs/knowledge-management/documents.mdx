...
import documentLinkEmbed from "../../../assets/screenshots/huly/documents-link-embed.png";
...
YouTube videos, PDFs and video files can be embedded directly into documents by pasting a URL or mentioning a file in your Huly [Drive](/knowledge-management/drive) and selecting `Show as a content preview` in the toolbar.

<Image src={documentLinkEmbed} alt="Embedding a link in a document" inferSize quality="max" />
...
Inline comments are attached to highlighted text in a document, and can be used to discuss specific parts of the document content with your team. To learn more about inline comments, check out [this guide](/communication/inline-comments).
