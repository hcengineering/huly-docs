...
To add custom fields to your contacts, click the cog icon in the top right corner of the details sidebar. You can also access this page by navigating to `Settings` and selecting [Classes and enums](/advanced-settings/classes-enums) and then `Person`. Here, you can add any fields you like to your contacts.
