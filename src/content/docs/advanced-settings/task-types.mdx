...
The default settings of the `Classic project` cannot be directly modified. In order to use your own customized task types and process states, you'll need to create a new [space type](/advanced-settings/space-types). This can only be done by the workspace owner or a user granted admin permissions.
