...
Once the document approval process has been completed and the document status is `Effective`, the training requests will be sent to the trainees. For more on this approval process, see our guide on [controlled documents](/eqms/controlled-documents).
