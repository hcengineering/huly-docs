...
<YouTube id="5kr5bm0kyxw" posterQuality="max" />
...
Once the document approval process has been completed and the document status is `Effective`, the training requests will be sent to the trainees. For more on this process, see our guide on [review and approval](/eqms/review-approval).
