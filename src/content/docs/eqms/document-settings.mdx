...
To transfer a document to a different space, click on the settings menu next to the document in the left side panel and select `Transfer`.  Here, you'll be able to select a space to transfer to, as well as the parent object for your document (if applicable). Click `Transfer` again to transfer the document.

> **Note:** Some team members may lose the ability to view or edit the document after transferring it, depending on the permissions settings for the destination space.