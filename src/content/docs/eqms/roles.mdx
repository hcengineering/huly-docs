...
**Controlled Documents:** Open the settings menu for any document and select `Edit documents space`. From here, you can first add members to the space and then assign members to each of the available roles.
