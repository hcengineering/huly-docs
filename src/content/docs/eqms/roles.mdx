...
> **Note:** Admin permissions for updating and deleting applies to top-level spaces, not the specific objects within them. For more on the heirarchy of spaces and objects, see our guide on [space types](/advanced-settings/space-types).
